            ...
            <div class="col-md-12">
                ...
                <form class="main_form" method="POST">
                    <div class="row">
                        ...
                        <div class=" col-md-12">
                            <button class="send" type="submit" name="submit">Sign Up</button>
                        </div>
                    </div>
                </form>
            </div>
...
<?php
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO customer SET
            CstFirstName='$firstName',
            CstLastName='$lastName',
            CstEmail='$Email',
            CstLocalAddress='$Address',
            CstRegDate=now(),
            CstUsername='$Username',
            CstPassword='$Password'";
...
?>
    ...
    <footer>
        <div id="contact" class="footer">
                ...
                <div class="row pdn-top-30">
                    <div class="col-md-12 ">
                        <div class="footer-box">
                            <div class="headinga">
                                <h3>Address</h3>
                                <span>Anagarika Darmapala MV</span>
                                <p>(041) 2250999
                                    <br>dyanamiccomputers@gmail.com</p>
                            </div>
                            <ul class="location_icon">
                                <li> <a href="https://www.facebook.com/DynamicMatara"><i class="fa fa-facebook-f"></i></a></li>
            ...
            <div class="copyright">
                <div class="container">
                    <p>© 2022 All Rights Reserved. Design By<a href="#"> NIBM</a></p>
                </div>
            </div>
        </div>
    </footer>
